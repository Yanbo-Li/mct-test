...
QT_MOC_LITERAL(5, 37, 10), // "setMinimum"
QT_MOC_LITERAL(6, 48, 10) // "setMaximum"

    },
    "Sliders\0valueChanged\0\0value\0setValue\0"
    "setMinimum\0setMaximum"
};
...
void Sliders::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Sliders::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Sliders::valueChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Sliders::staticMetaObject = {
    { &QGroupBox::staticMetaObject, qt_meta_stringdata_Sliders.data,
      qt_meta_data_Sliders,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void Sliders::valueChanged(int _t1)
{
