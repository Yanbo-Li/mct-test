...
BodePlotWindow::BodePlotWindow(MathEngine* me, Graphs * graphs) : ui(new Ui::BodePlotWindow)
{
    this->me = me;
    this->graphs = graphs;
...
{
    Plot P = graphs->getLink()->getPhase();
...
void BodePlotWindow::on_confirmButton_clicked()
{
    ...
    window->setCentralWidget(this->me->getCwPtr());
